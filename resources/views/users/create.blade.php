<x-app-layout>
    ...
    <div class="flex justify-center ">
        <div class="mt-6 w-6/12 bg-white p-6 rounded-xl mb-8">
            ...
            <div class="">
                <label for="profile_photo_path" class="mx-auto cursor-pointer flex w-5/12 flex-col items-center rounded-xl border-2 border-dashed border-blue-500 bg-white p-6 text-center">
