        ...
        <div class="flex">
            <div class="w-1/2">
                <label for="profile_photo_path"
                    class="mx-auto cursor-pointer flex w-10/12 flex-col items-center rounded-xl border-2 border-dashed border-blue-500 bg-white p-6 text-center">
            ...
            <div id="divImage" class="flex justify-center items-center w-1/2">
                <img src="{{ asset('storage/assets/usuario.png') }}" alt="" id="destinationImage"
